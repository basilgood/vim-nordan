...
call s:HL('Function',                 s:nord9,    '',        '')
call s:HL('Identifier',               s:nord8,   '',        '')
call s:HL('Macro',                    s:nord10,   '',        '')
call s:HL('Operator',                 s:nord9,    '',        '')
call s:HL('PreProc',                  s:nord9,    '',        '')
call s:HL('Special',                  s:nord8,   '',        '')
